...
@section('content')
    ...
    <div class="container mx-auto px-4">
        <h2 class="text-2xl font-bold text-center mb-8">Laundry Terdekat</h2>
        <div id="resultsContainer" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @if(isset($rekomendasi) && count($rekomendasi) > 0)
                ...
                @endforeach
            @else
                <div id="emptyStateInitial" class="text-center py-20 col-span-full bg-white rounded-lg shadow">
                    <i class="fas fa-search-location text-6xl text-blue-300 mb-4"></i>
                    <h4 class="text-2xl font-semibold text-gray-700 mb-2">Belum ada pencarian</h4>
                    <p class="text-gray-500 mb-6">Cari laundry terdekat dan temukan layanan terbaik untuk kebutuhanmu.</p>
                    <a href="/packages" class="inline-block bg-blue-500 text-white px-6 py-3 rounded-lg font-medium hover:bg-blue-600 transition">Lihat Paket</a>
                </div>
            @endif
        </div>
    </div>
