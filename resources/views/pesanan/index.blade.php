...
<body>
    <div class="container mt-5">
        ...
        <div class="mb-3">
            ...
            <button class="btn btn-outline-secondary">Menunggu</button>
            <button class="btn btn-outline-secondary">Diterima</button>
            <button class="btn btn-outline-secondary">Diproses</button>
            <button class="btn btn-outline-secondary">Selesai</button>
        </div>
